...
public class PlayList_ extends AppCompatActivity {

    public ListView listView;
    SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;
    Gson gson;
    public static ArrayList<String> play_list;
    public static String play_list1;
    public PlayListCus playListCus;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences=getSharedPreferences("playLists",MODE_PRIVATE);
        editor=sharedPreferences.edit();
        gson=new Gson();
        play_list1=sharedPreferences.getString("playLists",null);

        if(play_list1!=null && !play_list1.equals("[]"))
        {
            play_list=gson.fromJson(play_list1, new TypeToken<ArrayList<String>>() {}.getType());
            playListCus=new PlayListCus(PlayList_.this,R.layout.cus_play_list,play_list);
        }
        else
        {
            temp=new ArrayList<>();
            temp.add("No Playlist created!");
            playListCus=new PlayListCus(PlayList_.this,R.layout.cus_play_list,temp);
        }
        listView.setAdapter(playListCus);
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id){
            ...
            case R.id.menu1:
                ...
                Toast.makeText(PlayList_.this,"Item 1 Selected",Toast.LENGTH_LONG).show();
            ...
            case R.id.menu20:
                ...
                Intent intent1=new Intent(PlayList_.this,FavActivity.class);
                ...
                if(musicService!=null) {
                    ...
                    new Handler().post(() -> {
                        ...
                        timer_ok.setOnClickListener(v1 -> {
                            ...
                            {
                                Toast.makeText(PlayList_.this, "Enter time first!", Toast.LENGTH_SHORT).show();
                            }
                        });
            ...
            case R.id.menu6:
                ...
                Intent intent2=new Intent(PlayList_.this,AboutAcitvity.class);
                startActivity(intent2);

                return true;
            case R.id.menu7:

                Intent intent3=new Intent(PlayList_.this,SupportActivity.class);

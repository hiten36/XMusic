...
public class SupportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        coffee=findViewById(R.id.button2);
        meal=findViewById(R.id.button3);
        custom=findViewById(R.id.button4);

        coffee.setOnClickListener(v -> {

            Uri uri = Uri.parse("upi://pay").buildUpon()
                    .appendQueryParameter("pa", "hitenkhatri0-1@oksbi")
                    .appendQueryParameter("pn", "Hiten Khatri")
                    .appendQueryParameter("mc", "")
                    .appendQueryParameter("tr", "123456")
                    .appendQueryParameter("tn", "Tip")
                    .appendQueryParameter("am", "100")
                    .appendQueryParameter("cu", "INR")
                    .appendQueryParameter("url", "X Music")
                    .build();
            ...
            if(null != chooser.resolveActivity(getPackageManager())) {
                ...
                Toast.makeText(SupportActivity.this,"No UPI app found, please install one to continue", Toast.LENGTH_SHORT).show();
            }
    ...
    private void upiPaymentDataOperation(ArrayList<String> data) {
        if (isConnectionAvailable(SupportActivity.this)) {
            ...
            if (status.equals("success")) {
                ...
                Toast.makeText(SupportActivity.this, "Transaction successful.", Toast.LENGTH_SHORT).show();
            } else if ("Payment cancelled by user.".equals(paymentCancel)) {
                Toast.makeText(SupportActivity.this, "Payment cancelled by user.", Toast.LENGTH_SHORT).show();
            } else {
                Toast.makeText(SupportActivity.this, "Transaction failed.Please try again", Toast.LENGTH_SHORT).show();
            }
        } else {
            Toast.makeText(SupportActivity.this, "Internet connection is not available. Please check and try again", Toast.LENGTH_SHORT).show();
        }
    }

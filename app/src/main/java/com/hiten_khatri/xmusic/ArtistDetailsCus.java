...
import static com.hiten_khatri.xmusic.ArtistDetails.artistSongList;
...
public class ArtistDetailsCus extends ArrayAdapter<ArrayList<String>> {

    public TextView textView;
    public ArrayList<String> arr;
    public Context context;
    public ImageView imageView;
    public static ArrayList<Integer> queueList4=new ArrayList<>();
    public static String playNext4="";
    public Gson gson;

    public ArtistDetailsCus(@NonNull Context context, int resource, ArrayList arr) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        convertView.setOnClickListener(v -> {
            ...
            intent1.putExtra("currentSong",artistSongList1.get(position).getTitle());
            ...
            popupMenu.setOnMenuItemClickListener(item -> {
                ...
                switch (ids) {
                    ...
                    case R.id.menu8:
                        ...
                        queueList4.add(artistSongList.indexOf(artistSongList1.get(position).getTitle()));
                    ...
                    case R.id.menu4:
                        ...
                        String min=String.valueOf(Integer.parseInt(String.valueOf(artistSongList1.get(position).getDuration()).substring(0,3))/60);
                        String sec=String.valueOf(Integer.parseInt(String.valueOf(artistSongList1.get(position).getDuration()).substring(0,3))%60);
                        duration.setText(min+":"+sec);
                        MediaMetadataRetriever metaRetriver = new MediaMetadataRetriever();
                        metaRetriver.setDataSource(artistSongList1.get(position).getPath());
                    ...
                    case R.id.menu3:
                        ...
                        String path=artistSongList1.get(position).getPath();
                        ...
                        if (playlists == null || playlists.equals("[]")) {
                            ...
                            listView.setOnItemClickListener((parent1, view, position2, id) -> {
                                ...
                                if(ifsong!=null)
                                {
                                    ...
                                    if(!pl_1.contains(artistSongList1.get(position).getTitle())) {
                                        pl_1.add(artistSongList1.get(position).getTitle());
                                ...
                                else
                                {
                                    ...
                                    pl_2.add(artistSongList1.get(position).getTitle());
